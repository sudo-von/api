 ...
 */
export type ApplyOpenApiRequestMiddlewaresOptions = ConfigureOpenApiMiddlewaresOptions & ConfigureOpenApiValidatorMiddlewaresOptions;
/**
 ...
 */
export type ApplyOpenApiResponseMiddlewares = ConfigureOpenApiErrorMiddlewaresOptions;
/**
 ...
 */
export type ConfigureOpenApiErrorMiddlewaresOptions = Pick<IApiServiceInitOptions, "app">;
/**
 ...
 */
export type ConfigureOpenApiMiddlewaresOptions = Pick<IApiServiceInitOptions, "apiDoc" | "app" | "paths" | "logger">;
/**
 ...
 */
export type ConfigureOpenApiValidatorMiddlewaresOptions = Pick<IApiServiceInitOptions, "apiDoc" | "app">;
//# sourceMappingURL=middlewares.types.d.ts.map