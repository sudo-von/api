 ...
 */
export type ConfigureHeaderMiddlewaresOptions = Omit<IApiServiceInitOptions, "logger">;
/**
 ...
 */
export type ConfigureErrorMiddlewaresOptions = Pick<IApiServiceInitOptions, "app" | "logger">;
