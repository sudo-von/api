...
import {
  ApplyOpenApiRequestMiddlewaresOptions,
 ...
 */
const configureOpenApiMiddlewares = async ({
  apiDoc,
  app,
  logger,
  paths,
 ...
 */
const configureOpenApiValidatorMiddlewares = ({
  apiDoc,
  app,
}: ConfigureOpenApiValidatorMiddlewaresOptions) => {
  app.use(
 ...
 */
export const applyOpenApiRequestMiddlewares = async ({
  apiDoc,
  app,
  logger,
  paths,
